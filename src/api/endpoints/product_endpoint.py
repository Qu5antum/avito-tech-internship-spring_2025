...
from src.api.schemas.product_schema import ProductCreate, ProductOut
...
@product_router.post("/create/pvz/{pvz_id}", response_model=ProductOut, status_code=201)
...
@product_router.delete("/pvz/{pvz_id}/delete", status_code=200)
